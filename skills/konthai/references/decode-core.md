...
| RO-leet / อักษรพิเศษ | gamer glyph-art: decorative affixes + cross-script glyph subs for Thai/Latin letters | strip decorative affixes (record as register, §3), then **name the cipher and abstain** — emit `cipher-detected`, do not fabricate a reading. Background inventory (unverified, **do not auto-decode from it**): `references/ro-leet.md` |
